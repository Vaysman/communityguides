...
@user1 = User.create! :email => 'one@communityguides.eu', :password => '12345678', :fullname => 'User One Admin', :country_id => '1', :weburl => 'http://www.communityguides.eu', :shortbio => 'Short biography of Admin'
@user1.confirm!
@user2 = User.create! :email => 'two@communityguides.eu', :password => '12345678', :fullname => 'User Two', :country_id => '2', :weburl => 'http://www.communityguides.eu', :shortbio => 'Short biography of User2'
@user2.confirm!
